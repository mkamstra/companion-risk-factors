...
public class SimpleApp {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Trying to download gzip file from NDW");
    ...
    // Current measurements
    {
      ...
      try {
        ...
        if (gzDataList.size() == 1) {
          try {
            JavaRDD<List<SiteMeasurement>> siteMeasurements = gzData.map(new ParseCurrentMeasurementXml()); // Lazy, i.e. not executed before really needed
